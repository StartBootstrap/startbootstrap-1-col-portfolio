...
**[Click here to join the Slack channel!](http://startbootstrap.com/template-overviews/1-col-portfolio/)**

## Bugs and Issues

Have a bug or an issue with this template? [Open a new issue](https://github.com/BlackrockDigital/startbootstrap-1-col-portfolio/issues) here on GitHub or leave a comment on the [template overview page at Start Bootstrap](https://startbootstrap-slack.herokuapp.com/).
