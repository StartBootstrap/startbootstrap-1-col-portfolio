...
After downloading the template, simply edit the `index.html` and `css/1-col-portfolio.css` file to make changes. These are the only files you need to worry about, you can ignore everything else!
